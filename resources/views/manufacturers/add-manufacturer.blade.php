    ...
    <div class="col-12">
        <div class="card component-card_6">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ url('/store-manufacturer') }}">
                    @csrf
                    <div class="form-row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="Please Enter Name" name="manufacturer_name" value="{{old('manufacturer_name')}}" required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('shop_name') is-invalid @enderror" id="shop_name" placeholder="Please Enter Shop Name" name="shop_name" value="{{old('shop_name')}}" required>
                                @error('shop_name')
                                    <p class="error-field-msg">
                                        <strong class="text-danger">
                                            {{ $message }}
